...
- `shared` – konfigurationer og kode der skal bruges af flere apps (fx Clerk opsætning)
...
Fælles Clerk-konfiguration findes i `shared/clerk`, så web og mobil deler samme nøgler.
