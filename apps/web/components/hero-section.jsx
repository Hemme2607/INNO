...
export default function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-slate-950">
      ...
      <AnimatedGroup
        variants={fadeIn}
        className="mx-auto min-h-[540px] max-w-6xl px-5 pb-12 pt-16 sm:min-h-[720px] sm:px-6 sm:pb-14 sm:pt-20 lg:min-h-[900px] lg:px-8 lg:pb-24 lg:pt-32">
        <div className="grid items-start gap-10 sm:gap-12 lg:grid-cols-[1.05fr_1fr]">
            ...
            <div className="space-y-3">
              <form className="flex flex-col gap-3 sm:flex-row sm:items-center" onSubmit={handleSubmit}>
                <Input
                  ...
                  autoComplete="email"
                  className="h-11 w-full border-white/10 bg-slate-900/60 text-white placeholder:text-slate-400 shadow-[0_0_0_1px_rgba(255,255,255,0.04)] focus-visible:border-cyan-400/50 focus-visible:ring-2 focus-visible:ring-cyan-400/30 focus-visible:shadow-[0_0_0_1px_rgba(56,189,248,0.5),0_0_24px_rgba(56,189,248,0.25)] sm:h-12"
                  aria-label="Email for early access"
                />
                <Button
                  type="submit"
                  disabled={status === "loading"}
                  className="h-11 w-full gap-2 bg-sky-500 px-5 text-slate-900 shadow-lg shadow-sky-900/40 hover:bg-sky-400 sm:h-12 sm:w-auto disabled:opacity-70"
                >
          ...
          <div className="relative mx-auto w-full max-w-[560px] sm:max-w-[620px] lg:mx-0">
            ...
            <div className="relative rounded-2xl border border-white/10 bg-slate-900/70 p-3 shadow-2xl shadow-sky-950/40 backdrop-blur sm:p-4">
