...
export function SonaLogo({
  ...
  const resolvedStrokeWidth = isSharp ? 5.5 : strokeWidth;
  const ringStroke = isSharp ? "#6366f1" : "url(#sonaRingGrad)";
      ...
      <svg viewBox="0 0 200 200" width="100%" height="100%" role="img">
        ...
        <g
          style={{
            ...
            animation: isSharp ? "none" : `sonaSpin ${outerSpin}s linear infinite`,
          }}>
          <circle
            cx="100"
            cy="100"
            ...
            fill="none"
            stroke={ringStroke}
            strokeWidth={resolvedStrokeWidth * 8.75}
            filter={isSharp ? undefined : "url(#sonaSoftGlow)"}
          />
        </g>
        ...
        <g>
          {[42, 46, 50, 54].map((r, i) => {
            ...
            const sharpColor = `rgba(99,102,241,${opacity})`;
            ...
            return (
              <circle
                ...
                r={r}
                fill="none"
                stroke={isSharp ? sharpColor : `rgba(165,174,255,${opacity})`}
                strokeWidth={resolvedStrokeWidth}
                strokeDasharray="18 14"
                style={{
                  animation: isSharp ? "none" : `sonaScan ${duration}s linear infinite`,
                }}
              />
            );
          })}
